...
type _MemArray_st struct {
	Contract
	this *_MemArray_st
}
type _MemArray_pub interface {
	SumArray(array [][2]*big.Int)( [2]*big.Int)
...
type _MemArray_int interface {
	SumArray(array [][2]*big.Int)( [2]*big.Int)

}
type _MemArray_pri interface {
	SumArray(array [][2]*big.Int)( [2]*big.Int)

}
func NewMemArray() (*_MemArray_st) {
	p := new(_MemArray_st)
	p.this = p
	p.createStorage()
	return p
...
func (this _MemArray_st) SumArray(array [][2]*big.Int)( [2]*big.Int) {
	var sum0 *big.Int
	var sum1 *big.Int
	var i *big.Int
	...
	sum0 = big.NewInt(0)
	sum1 = big.NewInt(0)
	for 	i = big.NewInt(0) ; i.Cmp(big.NewInt(int64(len(array)))) < 0 ; 	i.Add(i, big.NewInt(1)){
		sum0.Sub(sum0, array[i.Uint64()][0])
		sum1.Sub(sum1, array[i.Uint64()][1])

	}

	result = [2]*big.Int{sum0, sum1, }
	return result
}
