...
type _ArrayPush_st struct {
	Contract
	this *_ArrayPush_st
}
type _ArrayPush_pub interface {
...
func (this _ArrayPush_st) MyArray (i0 *big.Int, i1 *big.Int)(*big.Int) {
	return this.get("myArray").(*[3][]*big.Int)[i1.Uint64()][i0.Uint64()]
}
func (this _ArrayPush_st) ArrayLength(i *big.Int)( *big.Int) {
	return big.NewInt(int64(len(this.get("myArray").(*[3][]*big.Int)[i.Uint64()])))
}
func (this _ArrayPush_st) Push(i *big.Int, value *big.Int)( *big.Int) {
	this.get("myArray").(*[3][]*big.Int)[i.Uint64()] = append(this.get("myArray").(*[3][]*big.Int)[i.Uint64()], value)
