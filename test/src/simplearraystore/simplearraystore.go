...
type _SimpleArrayStore_st struct {
	Contract
	this *_SimpleArrayStore_st
}
type _SimpleArrayStore_pub interface {
...
func NewSimpleArrayStore() (*_SimpleArrayStore_st) {
	p := new(_SimpleArrayStore_st)
	p.this = p
	p.createStorage()
	p.set("value",  new([20][20]*big.Int))
	return p
}

func (this _SimpleArrayStore_st) Set(_value *big.Int, ix *big.Int, iy *big.Int) {
	this.get("value").(*[20][20]*big.Int)[iy.Uint64()][ix.Uint64()]= new(big.Int).Set(_value)
}
