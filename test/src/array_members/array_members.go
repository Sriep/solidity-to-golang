...
func NewArrayMembers() (*_ArrayMembers_st) {
	...
	p.this = p
	p.createStorage()
	p.set("myArray",  *new([]*big.Int))
	return p
}

func (this _ArrayMembers_st) MyArray (i0 *big.Int)(*big.Int) {
	return this.get("myArray").([]*big.Int)[i0.Uint64()]
}
func (this _ArrayMembers_st) ArrayLength()( *big.Int) {
	return big.NewInt(int64(len(this.get("myArray").([]*big.Int))))
}
func (this _ArrayMembers_st) Push(newItem *big.Int)( *big.Int) {
	return big.NewInt(int64(len(this.set("myArray", append(this.get("myArray").([]*big.Int), newItem)).([]*big.Int)) ))
}
