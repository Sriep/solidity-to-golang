...
type _Animal_st struct {
	Contract
	this *_Animal_st
}
type _Animal_pub interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)
...
type _Animal_int interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
type _Animal_pri interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
func NewAnimal() (*_Animal_st) {
	p := new(_Animal_st)
	p.this = p
	p.createStorage()
	return p
...
type _Spider_int interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
type _Spider_pri interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
func NewSpider() (*_Spider_st) {
	p := new(_Spider_st)
	p.this = p
	p.createStorage()
	return p
...
func (this _Spider_st) Legs()( *big.Int) {
	return big.NewInt(6)
}
...
type _Cat_int interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
type _Cat_pri interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)
...
func (this _Cat_st) Legs()( *big.Int) {
	return big.NewInt(4)
}
...
type _Human_int interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
type _Human_pri interface {
	CountLegs(a Animal)( *big.Int)
	Legs()( *big.Int)

}
func NewHuman() (*_Human_st) {
	p := new(_Human_st)
	p.this = p
	p.createStorage()
	return p
...
func (this _Human_st) Legs()( *big.Int) {
	return big.NewInt(2)
}
