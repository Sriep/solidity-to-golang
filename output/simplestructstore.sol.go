...
type _SimpleStructStore_st struct {
	Contract
	this *_SimpleStructStore_st
}
type _SimpleStructStore_pub interface {
...
func NewSimpleStructStore() (*_SimpleStructStore_st) {
	...
	p.this = p
	p.createStorage()
	p.set("value",  new(Point_SimpleStructStore))
	return p
}

func (this _SimpleStructStore_st) Set(_x *big.Int, _y *big.Int) {
	this.get("value").(*Point_SimpleStructStore).x=_x
	this.get("value").(*Point_SimpleStructStore).y=_y
}
func (this _SimpleStructStore_st) GetX()( *big.Int) {
	return this.get("value").(*Point_SimpleStructStore).x
}
func (this _SimpleStructStore_st) GetY()( *big.Int) {
	return this.get("value").(*Point_SimpleStructStore).y
}
type Point_SimpleStructStore struct {
		x *big.Int
		y *big.Int
}
